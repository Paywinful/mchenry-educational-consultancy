      ...
      <div className="overflow-x-hidden">
          ...
          <div className="absolute inset-0 z-20 md:ml-10 flex items-center px-8">
            <div className="text-white max-w-2xl">
              ...
              <p className="text-md md:text-md mb-10 md:mb-12 font-thin">
                Your gateway to world-class education in Ghana’s top
                universities
              </p>
              <div className="md:flex hidden gap-4">
                <button onClick={()=>{route.push('/contact')}} className="bg-[#6B0F10] text-white px-8 py-1 text-xs md:px-12 md:py-2 rounded-3xl md:text-lg hover:border-[#6B0F10] hover:cursor-pointer hover:border hover:bg-transparent transition">
                  Get Started
                </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="bg-[#D9D9D9] p-10 rounded-xl shadow-md text-center">
              ...
              <p className="text-xs text-gray-700">
                Simply input your unique identification number to begin the
                process
              </p>
            </div>
        ...
        <div className="w-full bg-[#6B0F10] px-12 py-12 flex justify-between md:px-36">
          {[
            ...
            <div key={index} className="flex flex-col items-center">
              <h1 className="text-[#FFFBD6] text:3xl md:text-4xl font-black">
                {value}
              </h1>
        ...
        <div className="w-full py-16 bg-[#D9D9D9]">
          <div className="flex justify-center text-4xl font-extrabold text-center">
            <h2 className="text-[#6B0F10] mx-3">
              Secure <span className="text-black">& Transparent</span>
            </h2>
          </div>
        ...
        <div
          id="faq"
          className="w-full bg-white px-8 py-12 flex flex-col items-center"
        >
