              ...
              <div className="relative z-20 flex flex-col md:flex-row items-center justify-between w-full px-8 py-12 gap-12">
                <div className="flex-1 text-left">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 mt-2">
                    <button className="bg-white border border-[#6B0F10] text-[#6B0F10] px-4 py-3 rounded font-semibold hover:bg-gray-100 transition text-sm">
                      View application requirements
                    </button>
                    <button className="bg-[#6B0F10] text-white px-8 py-3 rounded font-semibold hover:bg-[#951A1B] transition text-sm">
                      <Link href="/portal/dashboard/student/application">Apply Now</Link>
                    </button>
                  </div>
                </div>
              </div>
