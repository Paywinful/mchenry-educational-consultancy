...
const navLinks = [
  { name: "Dashboard", href: "/portal/dashboard/student" },
  { name: "Application", href: "/portal/dashboard/student/application" },
  { name: "Payments", href: "/portal/dashboard/student/payments" },
  { name: "Profile", href: "/portal/dashboard/student/profile" },
];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="md:hidden p-4 bg-white shadow-md flex items-center justify-between">
          <span className="font-bold text-[#6B0F10] text-xl">McHenry</span>
