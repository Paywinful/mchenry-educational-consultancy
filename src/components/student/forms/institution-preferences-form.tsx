...
const institutions = [
  {
    ...
    ranking: 1,
    tuition: "$54,000",
    programs: ["Business", "Computer Science", "Medicine", "Law"],
  },
  {
    id: "2",
...
export function InstitutionPreferencesForm({
  ...
  const handleSubmit = useCallback(
    (e: React.FormEvent) => {
      e.preventDefault();
      console.log("Institution preferences saved:", {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Select your preferred institutions and programs
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Choose up to 5 institutions you'd like to apply to
            </p>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {institution.programs.slice(0, 3).map((program) => (
                        <Badge
                          key={program}
                          className="text-xs border border-gray-300 bg-white"
                        >
                          {program}
                        </Badge>
                      ))}
